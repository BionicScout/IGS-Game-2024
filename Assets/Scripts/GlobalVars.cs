...
public static class GlobalVars {
    ...
    public static Dictionary<Vector3Int, int> poisonTiles = new Dictionary<Vector3Int , int>(); //will store what tiles have poision and how many turns left
    public static Dictionary<Vector3Int, int> smokeTiles = new Dictionary<Vector3Int, int>(); //will store what tiles have poision and how many turns left
    ...
    public static Dictionary<Vector3Int, Stats> deadPlayers = new Dictionary<Vector3Int, Stats>(); 
